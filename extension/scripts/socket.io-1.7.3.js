!function (t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e(require("JSON")) : "function" == typeof define && define.amd ? define(["JSON"], e) : "object" == typeof exports ? exports.io = e(require("JSON")) : t.io = e(t.JSON)
}(this, function (t) {
    return function (t) {
        function e(n) {
        ...
        function n(t, e) {
            ...
            var r, n = s(t), a = n.source, p = n.id, u = n.path, f = h[p] && u in h[p].nsps,
        ...
        t.exports = e = n;
        var h = e.managers = {};
        e.protocol = a.protocol, e.connect = n, e.Manager = r(10), e.Socket = r(38)
    }, function (t, e, r) {
        (function (e) {
            "use strict";
        ...
        function o(t) {
            var r = "", n = !1;
            return r += t.type, e.BINARY_EVENT != t.type && e.BINARY_ACK != t.type || (r += t.attachments, r += "-"), t.nsp && "/" != t.nsp && (n = !0, r += t.nsp), null != t.id && (n && (r += ",", n = !1), r += t.id), null != t.data && (n && (r += ","), r += u.stringify(t.data)), r
        }
        ...
        function a(t) {
            var r = {}, n = 0;
            if (r.type = Number(t.charAt(0)), null == e.types[r.type]) return p();
            ...
            return t.charAt(++n) && (r = c(r, t.substr(n))), r
        }
        ...
        var u = (r(3)("socket.io-parser"), r(5)), f = r(6), l = r(7), d = r(9);
        e.protocol = 4, e.types = ["CONNECT", "DISCONNECT", "EVENT", "ACK", "ERROR", "BINARY_EVENT", "BINARY_ACK"], e.CONNECT = 0, e.DISCONNECT = 1, e.EVENT = 2, e.ACK = 3, e.ERROR = 4, e.BINARY_EVENT = 5, e.BINARY_ACK = 6, e.Encoder = n, e.Decoder = s, n.prototype.encode = function (t, r) {
            if (e.BINARY_EVENT == t.type || e.BINARY_ACK == t.type) i(t, r); else {
                var n = o(t);
                r([n])
            }
            ...
            e.deconstructPacket = function (t) {
                ...
                function i(e, c, h) {
                    ...
                    if (t.Blob && e instanceof Blob || t.File && e instanceof File) {
                        ...
                        p.onload = function () {
                            h ? h[c] = this.result : a = this.result, --s || r(a)
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (t) {
                ...
                return t && "function" == typeof Symbol && t.constructor === Symbol && t !== Symbol.prototype ? "symbol" : typeof t
            }, i = r(11), s = r(38), a = r(29), c = r(4), h = r(40), p = r(41),
            u = (r(3)("socket.io-client:manager"), r(36)), f = r(42), l = Object.prototype.hasOwnProperty;
        ...
        t.exports = r(13), t.exports.parser = r(20)
    }, function (t, e, r) {
        (function (e) {
            function n(t, r) {
            ...
            var i = r(14), s = r(29), a = (r(3)("engine.io-client:socket"), r(36)), c = r(20), h = r(2), p = r(37),
                u = r(30);
        ...
        (function (t) {
            ...
            var o = r(15), i = r(17), s = r(33), a = r(34);
        ...
        (function (e) {
            ...
            var a = r(15), c = r(18), h = r(29), p = r(31);
        ...
        var o = r(19), i = r(30), s = r(20), a = r(31), c = r(32);
        r(3)("engine.io-client:polling");
        t.exports = n;
        var h = function () {
            var t = r(15), e = new t({xdomain: !1});
        ...
        (function (t) {
            ...
            var h, p = r(21), u = r(22), f = r(23), l = r(24), d = r(25);
            t && t.ArrayBuffer && (h = r(27));
            ...
            var v = e.packets = {open: 0, close: 1, ping: 2, pong: 3, message: 4, upgrade: 5, noop: 6}, b = p(v),
                k = {type: "error", data: "parser error"}, w = r(28);
            e.encodePacket = function (e, r, i, a) {
                ...
                var h = v[e.type];
                return void 0 !== e.data && (h += i ? d.encode(String(e.data)) : String(e.data)), a("" + h)
                ...
                for (var o = t, i = [], s = !1; o.byteLength > 0;) {
                    for (var a = new Uint8Array(o), c = 0 === a[0], h = "", p = 1; 255 != a[p]; p++) {
                        if (h.length > 310) {
                            s = !0;
                            break
                        }
        ...
        (function (t, o) {
            !function (i) {
                ...
                function p(t) {
                    for (var e, r = s(t), n = r.length, o = -1, i = ""; ++o < n;) e = r[o], i += h(e);
                    return i
                }

                function u() {
                    if (v >= g) throw Error("Invalid byte index");
                    var t = 255 & m[v];
                ...
                var m, g, v, b = String.fromCharCode, k = {version: "1.0.0", encode: p, decode: l};
                n = function () {
                    return k
        ...
        (function (e) {
            function n(t) {
                var e = t && t.forceBase64;
                e && (this.supportsBinary = !1), this.perMessageDeflate = t.perMessageDeflate, this.usingBrowserWebSocket = p && !t.forceNode, this.usingBrowserWebSocket || (u = o), i.call(this, t)
            }

            var o, i = r(19), s = r(20), a = r(30), c = r(31), h = r(32),
            ...
            u || "undefined" != typeof window || (u = o), t.exports = n, c(n, i), n.prototype.name = "websocket", n.prototype.supportsBinary = !0, n.prototype.doOpen = function () {
                if (this.check()) {
                    ...
                    try {
                        this.ws = this.usingBrowserWebSocket ? new u(t) : new u(t, e, r)
                    } catch (t) {
        ...
        var o = r(4), i = r(29), s = r(39), a = r(40), c = r(41), h = (r(3)("socket.io-client:socket"), r(22));
        t.exports = e = n;
        var p = {
            connect: 1,
            connect_error: 1,
        ...
        i(n.prototype), n.prototype.subEvents = function () {
            ...
            if (p.hasOwnProperty(t)) return u.apply(this, arguments), this;
            var e = s(arguments), r = o.EVENT;
            h(e) && (r = o.BINARY_EVENT);
            var n = {type: r, data: e};
            return n.options = {}, n.options.compress = !this.flags || !1 !== this.flags.compress, "function" == typeof e[e.length - 1] && (this.acks[this.ids] = e.pop(), n.id = this.ids++), this.connected ? this.packet(n) : this.sendBuffer.push(n), delete this.flags, this
        }, n.prototype.packet = function (t) {
            ...
            var e = t.data || [];
            null != t.id && e.push(this.ack(t.id)), this.connected ? u.apply(this, e) : this.receiveBuffer.push(e)
        }, n.prototype.ack = function (t) {
            var e = this, r = !1;
            return function () {
                if (!r) {
                    r = !0;
                    var n = s(arguments), i = h(n) ? o.BINARY_ACK : o.ACK;
